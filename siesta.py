...
# disp = Prism(name="disperser prism", glass_type=["specs","SCHOTT-optical","N-F2"], beam_diameter=20, base=50, apex_angle_deg=45, input_angle_deg=18, manual=False, spectral_range_nm=spectral_range, spectral_res_nm=spectral_res) #sf11 manual prism
# disp2 = Prism(name="disperser prism 2", glass_type=["specs","SCHOTT-optical","F2"], beam_diameter=20, base=50, apex_angle_deg=60, input_angle_deg=50, manual=False, prev=disp, spectral_range_nm=spectral_range, spectral_res_nm=spectral_res) #sf11 manual prism
